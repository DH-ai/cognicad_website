    ...
    <main className="relative z-10 min-h-[100dvh] bg-canvas pt-28 pb-24 md:pt-36">
      <div className="container-jc">
        <header className="mb-10">
          <Link href="/admin/blog" className="type-tech text-muted underline underline-offset-4">Back to posts</Link>
          <h1 className="type-section text-fg mt-6">Edit field note</h1>
        </header>
        <BlogEditor post={post} />
        <DeleteBlogPost id={post.id} title={post.title} />
      </div>
    </main>
  );
}
