...
export default function Footer() {
  return (
    <footer className="bg-[var(--color-void)] border-t border-[var(--color-border-subtle)] py-20 px-6 md:px-12">
      <div className="max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] gap-12 mb-20">
          {/* Brand */}
          <div className="flex flex-col gap-6">
            <span className="font-script text-5xl text-[var(--color-accent)] leading-none">
              CogniCAD
            </span>
